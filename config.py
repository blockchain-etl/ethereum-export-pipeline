...
EXPORT_RECEIPTS_AND_LOGS_COMMAND = SETUP_COMMAND + ' && ' + \
    "python3 ethereumetl.py extract_csv_column -i ${INPUT1_STAGING_DIR}/transactions_${PADDED_START}_${PADDED_END}.csv -o ${OUTPUT1_STAGING_DIR}/transaction_hashes.csv.temp -c hash && " + \
    "python3 ethereumetl.py export_receipts_and_logs --transaction-hashes ${OUTPUT1_STAGING_DIR}/transaction_hashes.csv.temp -p $IPC_PATH -w 1 " + \
